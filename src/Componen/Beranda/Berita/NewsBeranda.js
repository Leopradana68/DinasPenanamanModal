...
function NewsBeranda() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        "http://adminmesuji.embuncode.com/api/news?instansi_id=10&per_page=3&sort_type=desc&sort_by=created_at"
      )
      .then(function (NewsTerbaru) {
        // handle success
        // console.log("response :>>", response);
        // console.log(response.data.data.data);

        setDataNews(NewsTerbaru.data.data.data);
      })
  ...
  useEffect(() => {
    ...
    axios
      .get(
        "http://adminmesuji.embuncode.com/api/news?instansi_id=10&per_page=4&sort_type=desc&sort_by=total_hit"
      )
  ...
  return (
    <Container>
      <Row>
        {/* ====== Menampilkan Berita terbaru diberanda====== */}
        <Col md={8}>
          <div className="style-btn hot-news">
            <h3><strong>Berita </strong> Terbaru</h3>
          </div>
          <div>
            {DataNews &&
                    ...
                    <Card>
                      ...
                      <Card.Body>
                        ...
                        <p className="read-more-nya">
                          <a href={`/Beranda/DetailNews/${item.id}`}>
                            {" "}
        ...
        {/* ====== Menampilkan Berita populer diberanda====== */}
        <Col md={4}>
          <div className="style-btn hot-news">
            <h3>
              {" "}
                ...
                return (
                  <div class="cards-type">
                    ...
                    <div class="card__info">
                      <Link to={`/Beranda/DetailNews/${item.id}`}>
                        <h5>{item.title}</h5>
                      </Link>
